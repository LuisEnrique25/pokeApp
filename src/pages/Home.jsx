...
const Home = () => {
  ...
  return (
    <main className='grid grid-rows-[1fr_auto] min-h-screen bg-slate-50 '>
        <section className=' flex flex-col justify-center items-center p-4 gap-4'>
            ...
            <form onSubmit={handleSubmit} className='flex rounded-sm overflow-hidden shadow-md'>
                ...
                <input required id='nameTrainer' type="text" placeholder='Type your name...' className=' p-2 outline-none w-52 sm:w-auto '/>
